    ...
    <div class="app-container container-fluid d-flex align-items-stretch justify-content-between"
        ...
        <div class="d-flex align-items-center flex-grow-1 flex-lg-grow-0">
            <a href="index.html" class="d-lg-none">
                <img alt="Logo" src="assets_admin/media/logos/default-small.svg" class="h-30px" />
            </a>
        </div>
                ...
                <div class="app-navbar-item ms-1 ms-md-4">
                    ...
                    <div class="menu menu-sub menu-sub-dropdown menu-column w-350px w-lg-375px" data-kt-menu="true"
                        ...
                        <div class="d-flex flex-column bgi-no-repeat rounded-top"
                            style="
        background-image: url('assets_admin/media/misc/menu-header-bg.jpg');
      ">
                ...
                <div class="app-navbar-item ms-1 ms-md-4" id="kt_header_user_menu_toggle">
                    <div class="cursor-pointer symbol symbol-35px"
                        ...
                        <img src="assets_admin/media/avatars/300-3.jpg" class="rounded-3" alt="user" />
                    </div>
                            ...
                            <a href="#" class="menu-link px-5">
                                <span class="menu-title position-relative">Language
                                    <span
                                        ...
                                        Nam
                                        <img class="w-15px h-15px rounded-1 ms-2" src="assets_admin/media/flags/vietnam.svg"
                                            alt="" /></span></span>
                            </a>
                                ...
                                <div class="menu-item px-3">
                                    <a href="account/settings.html" class="menu-link d-flex px-5 active">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1" src="assets_admin/media/flags/vietnam.svg"
                                                alt="" /> </span>Việt Nam</a>
                                </div>
                                <div class="menu-item px-3">
                                    <a href="account/settings.html" class="menu-link d-flex px-5">
                                        <span class="symbol symbol-20px me-4">
                                            <img class="rounded-1" src="assets_admin/media/flags/united-states.svg"
                                                alt="" />
                                        </span>English</a>
                                </div>
                            </div>
